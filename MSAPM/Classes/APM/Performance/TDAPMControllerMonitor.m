...
+ (void)toHookInitViewController:(Class)class {
    ...
    void (^swizzledBlock)(UIViewController *) = ^(UIViewController *viewController) {
        ...
        [[MSAPMManager sharedInstance] asyncExecuteClassName:className withStartTime:[NSString stringWithFormat:@"%lld",start] withEndTime:[NSString stringWithFormat:@"%lld",end] withHookMethod:@"initWithNibName:bundle:" withUniqueIdentifier: uniqueIdentifier];
    };
...
+ (void)toHookLoadView:(Class)class {
    ...
    void (^swizzledBlock)(UIViewController *) = ^(UIViewController *viewController) {
       ...
       // NSLog(@"loadView = %@",viewController);
        NSString *className = [[NSString alloc]initWithUTF8String:class_getName(class)];
        NSString *uniqueIdentifier = [NSString stringWithFormat:@"%@%lud",className,(unsigned long)viewController.hash];
        [[MSAPMManager sharedInstance] asyncExecuteClassName:className withStartTime:[NSString stringWithFormat:@"%lld",start] withEndTime:[NSString stringWithFormat:@"%lld",end] withHookMethod:@"loadView" withUniqueIdentifier: uniqueIdentifier];
    };
    [self replaceImplementationOfKnownSelector:selector onClass:class withBlock:swizzledBlock swizzledSelector:swizzledSelector];
}
+ (void)toHookViewDidLoad:(Class)class {
    ...
    void (^swizzledBlock)(UIViewController *) = ^(UIViewController *viewController) {
        ...
        NSString *className = [[NSString alloc]initWithUTF8String:class_getName(class)];
        NSString *uniqueIdentifier = [NSString stringWithFormat:@"%@%lud",className,(unsigned long)viewController.hash];
        [[MSAPMManager sharedInstance] asyncExecuteClassName:className withStartTime:[NSString stringWithFormat:@"%lld",start] withEndTime:[NSString stringWithFormat:@"%lld",end] withHookMethod:@"viewDidLoad" withUniqueIdentifier: uniqueIdentifier];
    };
    [self replaceImplementationOfKnownSelector:selector onClass:class withBlock:swizzledBlock swizzledSelector:swizzledSelector];
}
...
+ (void)toHookViewWillAppear:(Class)class {
    ...
    void (^swizzleBlock)(UIViewController *vc,BOOL animated) = ^(UIViewController *viewController, BOOL animated) {
        ...
        NSString *className = [[NSString alloc]initWithUTF8String:class_getName(class)];
        NSString *uniqueIdentifier = [NSString stringWithFormat:@"%@%lud",className,(unsigned long)viewController.hash];
        [[MSAPMManager sharedInstance] asyncExecuteClassName:className withStartTime:[NSString stringWithFormat:@"%lld",start] withEndTime:[NSString stringWithFormat:@"%lld",end] withHookMethod:@"viewWillAppear" withUniqueIdentifier: uniqueIdentifier];
    };
...
+ (void)toHookViewDidAppear:(Class)class {
    ...
    void (^swizzleBlock)(UIViewController *vc,BOOL animated) = ^(UIViewController *viewController, BOOL animated) {
        ...
        NSString *className = [[NSString alloc]initWithUTF8String:class_getName(class)];
        NSString *uniqueIdentifier = [NSString stringWithFormat:@"%@%lud",className,(unsigned long)viewController.hash];
        [[MSAPMManager sharedInstance] asyncExecuteClassName:className withStartTime:[NSString stringWithFormat:@"%lld",start] withEndTime:[NSString stringWithFormat:@"%lld",end] withHookMethod:@"viewDidAppear" withUniqueIdentifier: uniqueIdentifier];
    };
    [self replaceImplementationOfKnownSelector:originalSelector onClass:class withBlock:swizzleBlock swizzledSelector:swizzledSelector];
}
...
+ (void)toHookViewWillDisappear:(Class)class {
    ...
    void (^swizzleBlock)(UIViewController *vc,BOOL animated) = ^(UIViewController *viewController, BOOL animated) {
      ...
      //  NSLog(@"swizzled viewWillDisappear %@ %f %@",vc.class,cast,[[NSString alloc]initWithUTF8String:class_getName(class)]);
        NSString *className = [[NSString alloc]initWithUTF8String:class_getName(class)];
        NSString *uniqueIdentifier = [NSString stringWithFormat:@"%@%lud",className,(unsigned long)viewController.hash];
        [[MSAPMManager sharedInstance] asyncExecuteClassName:className withStartTime:[NSString stringWithFormat:@"%lld",start] withEndTime:[NSString stringWithFormat:@"%lld",end] withHookMethod:@"viewWillDisappear" withUniqueIdentifier: uniqueIdentifier];
    };
    [self replaceImplementationOfKnownSelector:originalSelector onClass:class withBlock:swizzleBlock swizzledSelector:swizzledSelector];
}
...
//        NSDictionary *dict = @{@"type": [[NSNumber alloc]initWithInt:4],@"currntTime": [NSString stringWithFormat:@"%f",end],@"content":[[NSString alloc]initWithUTF8String:class_getName(class)]};
        NSString *className = [[NSString alloc]initWithUTF8String:class_getName(class)];
        NSString *uniqueIdentifier = [NSString stringWithFormat:@"%@%lud",className,(unsigned long)viewController.hash];
        [[MSAPMManager sharedInstance] asyncExecuteClassName: className withStartTime:[NSString stringWithFormat:@"%lld",start] withEndTime:[NSString stringWithFormat:@"%lld",end] withHookMethod:@"viewDidDisappear" withUniqueIdentifier: uniqueIdentifier];
    };
    [self replaceImplementationOfKnownSelector:originalSelector onClass:class withBlock:swizzleBlock swizzledSelector:swizzledSelector];
}
